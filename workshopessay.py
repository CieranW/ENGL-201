...
def essay3():  # Expand upon.
    ...
    def first_part():
        ...
        essay in a programming language
        is getting it to run as smooth as you envision it to. 
        Nevertheless, I had extra time on my hand and I had already made that
        initial commitment, I was not backing down from this, nor would I stop 
